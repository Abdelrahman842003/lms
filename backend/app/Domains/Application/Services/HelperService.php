...
class HelperService
{
    ...
    public static function getTeacherPricePerStudent(): float
    {
        return (float) CacheService::getSetting(
            ...
            fn() => \App\Domains\Application\Models\Setting::where('key', 'teacher_price_per_student')->value('value') ?? 60
        );
    }
    ...
    public static function getAcademyPricePerStudent(): float
    {
        return (float) CacheService::getSetting(
            ...
            fn() => \App\Domains\Application\Models\Setting::where('key', 'academy_price_per_student')->value('value') ?? 40
        );
    }
    ...
    public static function getTrialPeriodDays(): int
    {
        return (int) CacheService::getSetting(
            'trial_period_days',
            fn() => \App\Domains\Application\Models\Setting::where('key', 'trial_period_days')->value('value') ?? 14
        );
    }
