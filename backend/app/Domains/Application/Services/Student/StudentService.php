...
class StudentService
{
    ...
    public function getEnrolledTeachers(Student $student): array
    {
        return $student->enrollments()
            ->with(['teacher:id,name,avatar_key,status,trial_period_days,plan_expires_at', 'grade:id,name', 'group:id,name'])
            ->get()
    ...
    public function getEnrolledTeachersGrouped(Student $student): array
    {
        $enrollments = $student->enrollments()
            ->with([
                'teacher:id,name,avatar_key,status,trial_period_days,plan_expires_at',
