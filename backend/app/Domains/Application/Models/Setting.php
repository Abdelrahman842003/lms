...
class Setting extends Model
{
    ...
    {
        return \App\Domains\Application\Services\CacheService::getSettingWithTtl($key, \App\Domains\Application\Services\CacheService::TTL_SHORT, function () use ($key, $default) {
    ...
    {
        static::saved(fn($setting) => \App\Domains\Application\Services\CacheService::forgetSetting($setting->key));
        static::deleted(fn($setting) => \App\Domains\Application\Services\CacheService::forgetSetting($setting->key));
    }
}
