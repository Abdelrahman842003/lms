...
use App\Domains\Auth\DTOs\TeacherData;
use App\Domains\Application\Http\Controllers\Controller;
use App\Domains\Application\Http\Requests\Academy\CheckTeacherPhoneRequest;
use App\Domains\Application\Http\Requests\Academy\StoreTeacherRequest;
use App\Domains\Application\Http\Resources\Academy\TeacherResource;
use App\Domains\Application\Services\Academy\TeacherService;
use Carbon\Carbon;
...
class TeacherController extends Controller
{
    ...
    public function update(\App\Domains\Application\Http\Requests\Academy\UpdateTeacherRequest $request, string $id): JsonResponse
    {
        $academy = $request->user();
        
        try {
            $data = \App\Domains\Auth\DTOs\TeacherData::fromRequest($request);
