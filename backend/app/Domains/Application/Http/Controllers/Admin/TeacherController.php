...
use App\Domains\Application\Http\Requests\Admin\Teacher\UpdateSubscriptionRequest;
use App\Domains\Application\Http\Requests\Admin\Teacher\GetSubscriptionRequest;
...
class TeacherController extends Controller
{
    ...
    public function store(\App\Domains\Application\Http\Requests\Admin\StoreTeacherRequest $request)
    {
    ...
    public function show($id)
    {
        try {
            ...
            return $this->successResponse([
                'teacher' => new \App\Domains\Application\Http\Resources\Teacher\TeacherResource($teacher)
            ]);
    ...
    public function update(\App\Domains\Application\Http\Requests\Admin\UpdateTeacherRequest $request, $id)
    {
