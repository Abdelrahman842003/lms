...
class Setting extends Model
{
    ...
    {
        static::saved(fn($setting) => \App\Domains\Support\Services\CacheService::forgetSetting($setting->key));
        static::deleted(fn($setting) => \App\Domains\Support\Services\CacheService::forgetSetting($setting->key));
    }
}
