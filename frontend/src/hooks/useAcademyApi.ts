...
export function useApiClient() {
  ...
  return {
    get: <T>(endpoint: string, options?: Parameters<typeof apiClient.get>[1]) =>
      apiClient.get<T>(endpoint, options),
    post: <T>(endpoint: string, data?: unknown, options?: Parameters<typeof apiClient.post>[2]) =>
      apiClient.post<T>(endpoint, data, options),
    put: <T>(endpoint: string, data?: unknown, options?: Parameters<typeof apiClient.put>[2]) =>
      apiClient.put<T>(endpoint, data, options),
    patch: <T>(endpoint: string, data?: unknown, options?: Parameters<typeof apiClient.patch>[2]) =>
      apiClient.patch<T>(endpoint, data, options),
    delete: <T>(endpoint: string, options?: Parameters<typeof apiClient.delete>[1]) =>
