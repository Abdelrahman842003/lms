              ...
              <div className="space-y-3">
                {filteredNotifications.map((notification) => (
                  <div
                    ...
                    className={`p-4 bg-white/5 rounded-xl border cursor-pointer transition-all duration-300 hover:bg-white/10 ${
                      !notification.read_at ? 'border-primary/50' : 'border-white/10'
                    }`}
                  >
