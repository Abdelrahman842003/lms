...
export default function CreateLecturePage() {
  ...
  useEffect(() => {
    const fetchTeachers = async () => {
      try {
        const teachersResponse = await academyService.getLectureTeachers();
  ...
  // Fetch grades and groups when teacher is selected
  useEffect(() => {
        ...
        <form onSubmit={handleSubmit} className="bg-gray-900/50 backdrop-blur-md border border-white/5 rounded-2xl p-6">
          <div className="space-y-6">
            ...
            <div className="form-group">
              <label htmlFor="teacher" className="block text-white mb-2">المدرس</label>
              <Filter
