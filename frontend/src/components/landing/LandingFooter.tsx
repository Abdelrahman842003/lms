...
export default function LandingFooter() {
  ...
  return (
    <footer className="relative py-8 z-20 border-t border-border-theme-secondary bg-transparent">
      <div className="max-w-[1200px] mx-auto px-6">
        <div className="flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          <div className="flex items-center gap-3 grayscale opacity-60 hover:grayscale-0 hover:opacity-100 transition-all duration-300">
             ...
             <span className="text-text-theme-primary font-bold tracking-wide text-sm">{projectName}</span>
          </div>
          
          {/* Copyright */}
          <div className="text-center order-3 md:order-2">
            <p className="text-text-theme-muted text-[0.75rem]">
              © {new Date().getFullYear()} {projectName} للتقنيات التعليمية. جميع الحقوق محفوظة.
            </p>
          </div>

          {/* Links */}
          <div className="flex flex-wrap items-center justify-center md:justify-end gap-x-6 gap-y-3 text-[0.85rem] text-text-theme-secondary order-2 md:order-3">
