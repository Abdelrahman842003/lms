                  ...
                  <div className="flex-1 flex flex-col bg-transparent relative overflow-hidden">
                    ...
                    <div className="flex-1 p-3 md:p-5 overflow-hidden flex flex-col gap-3 md:gap-5">
                       ...
                       <div className="grid grid-cols-2 lg:grid-cols-3 gap-2 md:gap-4 shrink-0">
                         <div className="bg-[#111524] border border-white/5 rounded-xl p-2.5 md:p-3.5 flex flex-col gap-2 hover:border-[#27c93f]/30 transition-all cursor-pointer shadow-lg">
