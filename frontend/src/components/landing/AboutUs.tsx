    ...
    <div className="relative overflow-x-hidden text-text-theme-primary font-[Tajawal] selection:bg-[#3249A9] selection:text-white pb-20">
      ...
      <section className="relative pt-32 pb-20 md:pt-40" style={{ perspective: '1500px' }}>
        <div className="max-w-[1000px] mx-auto px-6 text-center">
          ...
          <p className="text-[1.05rem] md:text-[1.15rem] text-text-theme-secondary max-w-[750px] mx-auto mb-16 leading-relaxed">
            {about.description}
          </p>

          <div className="bg-surface-secondary border border-border-theme-primary rounded-3xl p-8 md:p-12 text-right relative overflow-hidden shadow-2xl">
            {/* Background Glow */}
            ...
            <div className="relative z-10 grid grid-cols-1 md:grid-cols-2 gap-10">
              <div>
                <h3 className="text-2xl font-bold text-text-theme-primary mb-4">مهمتنا</h3>
                <p className="text-text-theme-secondary leading-relaxed text-[0.95rem]">
                  {about.mission}
                </p>
              </div>
              
              <div>
                <h3 className="text-2xl font-bold text-text-theme-primary mb-4">قيمنا الجوهرية</h3>
                <ul className="space-y-3 text-text-theme-secondary text-[0.95rem]">
            ...
            <div className="mt-12 pt-8 border-t border-border-theme-primary flex flex-col sm:flex-row items-center justify-between gap-6">
              <div className="flex items-center gap-4">
                <div className="text-center">
                  <div className="text-3xl font-bold text-text-theme-primary mb-1">+500</div>
                  <div className="text-xs text-text-theme-muted">مؤسسة تعليمية</div>
                </div>
                <div className="w-px h-10 bg-border-theme-primary hidden sm:block"></div>
                <div className="text-center">
                  <div className="text-3xl font-bold text-text-theme-primary mb-1">+50k</div>
                  <div className="text-xs text-text-theme-muted">طالب نشط</div>
                </div>
                <div className="w-px h-10 bg-border-theme-primary hidden sm:block"></div>
                <div className="text-center">
                  <div className="text-3xl font-bold text-text-theme-primary mb-1">99.9%</div>
                  <div className="text-xs text-text-theme-muted">استقرار النظام</div>
                </div>
              </div>
