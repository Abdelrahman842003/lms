...
export default function LandingLayout({ children }: LandingLayoutProps) {
  return (
    <div className="min-h-screen relative flex flex-col bg-transparent text-text-theme-primary transition-colors duration-300 font-[Tajawal] selection:bg-[#3249A9] selection:text-white overflow-x-hidden">
