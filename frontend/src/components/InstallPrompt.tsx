...
export default function InstallPrompt() {
  ...
  return (
    <div className="ux-fixed ux-bottom-4 ux-left-4 ux-right-4 ux-md-left-auto ux-md-right-4 ux-md-w-96 premium-glass premium-border ux-p-4 ux-rounded-xl ux-z-9999 ux-animate-slide-up">
      <div className="ux-flex ux-items-start ux-gap-4">
        ...
        <div className="ux-flex-1">
          ...
          <p className="ux-text-gray-light ux-text-sm ux-mb-4">
